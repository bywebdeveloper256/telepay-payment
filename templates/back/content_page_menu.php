    ...
    <div class="row justify-content-center">
        <div class="col-md-8 p-5">
            ...
            <div class="row mb-5">
                ...
                <label for="telepay-time-exp"><?= esc_html__( "Add the maximum expiration time of an invoice (In minutes) in case the client does not make the payment.", telepay_text_domain ) ?></label>
            </div>
